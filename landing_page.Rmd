...
If you've not been to one before, we'd love you to join us! Our next *public* event is on `r paste(day(date), months(date), year(date) )` at [The Centre Page, near 
St Paul's Cathedral](https://goo.gl/maps/mGKmmAF8Qms). People normally arrive from about 6:30pm onwards. If you're worried about finding us, don't. We are easy to spot. Please come over and introduce yourself. Failing that, ask in the [new players chat room](#newplayerchatrooms).
